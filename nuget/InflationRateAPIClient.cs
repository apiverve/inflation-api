...
namespace APIVerve.API.InflationRate
{
    ...
    /// <summary>
    /// Client for the InflationRate API
    /// </summary>
    public class InflationRateAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/inflation";
        ...
        public InflationRateAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public InflationRateAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public InflationRateAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, InflationRateQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(InflationRateQueryOptions options)
        {
        ...
        public ResponseObj Execute(InflationRateQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(InflationRateQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(InflationRateQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(InflationRateQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(InflationRateQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(InflationRateQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(InflationRateQueryOptions options)
        {
