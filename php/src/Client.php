...
/**
 * Client for the Inflation Rate API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/inflation?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/inflation';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\InflationClient] {$message}\n";
        }
    }
}
