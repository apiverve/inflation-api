...
```gradle
dependencies {
    implementation 'com.github.apiverve:inflation-api:1.1.14'
}
```
...
```java
import com.apiverve.inflation.InflationRateAPIClient;
import com.apiverve.inflation.APIResponse;
import com.apiverve.inflation.APIException;

// Initialize the client
InflationRateAPIClient client = new InflationRateAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/inflation](https://docs.apiverve.com/ref/inflation)
...
- **Documentation:** [https://docs.apiverve.com/ref/inflation](https://docs.apiverve.com/ref/inflation)
- **Issues:** [GitHub Issues](https://github.com/apiverve/inflation-api/issues)
