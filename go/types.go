...
// Request contains the parameters for the Inflation Rate API.
//
// Parameters:
...
// ResponseData contains the data returned by the Inflation Rate API.
type ResponseData struct {
	Country string `json:"country"`
	CountryName string `json:"countryName"`
	Year int `json:"year"`
	InflationRate float64 `json:"inflationRate"`
	CpiIndex float64 `json:"cpiIndex"`
	CpiBaseYear int `json:"cpiBaseYear"`
